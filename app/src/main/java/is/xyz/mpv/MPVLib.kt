...
// Wrapper for native library - must use is.xyz.mpv package to match libplayer.so JNI symbols
...
object MPVLib {
    ...
    external fun grabThumbnail(dimension: Int): android.graphics.Bitmap?
